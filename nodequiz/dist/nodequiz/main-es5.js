...
/***/ "./node_modules/raw-loader/index.js!./src/app/cummulative-summary/cummulative-summary.component.html":
/*!**************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/cummulative-summary/cummulative-summary.component.html ***!
  \**************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
module.exports = "<div class=\"mainContent\">\n  <h1 class=\"loginHeader\" color=\"primary\">NodeQuiz</h1>\n  <form [formGroup]=\"employeeLogin\"(ngSubmit)='loginEmployee(employeeLogin)'>\n  <p>Please Enter Employee Id</p>\n    <label>\n    <input type=\"text\" formControlName=\"employeeId\">\n  </label>\n  <p *ngIf=\"errorMessage\">{{errorMessage}}</p>\n</form>\n</div>\n\n"

/***/ }),

/***/ "./node_modules/raw-loader/index.js!./src/app/quiz-carousel-dialog/quiz-carousel-dialog.component.html":
/*!****************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/quiz-carousel-dialog/quiz-carousel-dialog.component.html ***!
  \****************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {
...
/* harmony import */ var primeng_carousel__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! primeng/carousel */ "./node_modules/primeng/carousel.js");
/* harmony import */ var primeng_carousel__WEBPACK_IMPORTED_MODULE_22___default = /*#__PURE__*/__webpack_require__.n(primeng_carousel__WEBPACK_IMPORTED_MODULE_22__);
...
/* harmony import */ var _quiz_carousel_dialog_quiz_carousel_dialog_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./quiz-carousel-dialog/quiz-carousel-dialog.component */ "./src/app/quiz-carousel-dialog/quiz-carousel-dialog.component.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            declarations: [
                ...
                _shared__WEBPACK_IMPORTED_MODULE_8__["BaseLayoutComponent"],
            ...
            imports: [
                ...
                primeng_carousel__WEBPACK_IMPORTED_MODULE_22__["CarouselModule"],
...
var AppRoutes = [
    {
        ...
        children: [
            ...
            { path: 'quiz/:id',
                component: _quiz_quiz_component__WEBPACK_IMPORTED_MODULE_4__["QuizComponent"],
                canActivate: [_shared_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
            },
            {
                path: 'past-quizes',
                component: _cummulative_summary_cummulative_summary_component__WEBPACK_IMPORTED_MODULE_5__["CummulativeSummaryComponent"],
                canActivate: [_shared_auth_guard__WEBPACK_IMPORTED_MODULE_3__["AuthGuard"]]
            }
        ]
    }
...
/***/ "./src/app/cummulative-summary/cummulative-summary.component.css":
/*!***********************************************************************!*\
  !*** ./src/app/cummulative-summary/cummulative-summary.component.css ***!
  \***********************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL2N1bW11bGF0aXZlLXN1bW1hcnkvY3VtbXVsYXRpdmUtc3VtbWFyeS5jb21wb25lbnQuY3NzIn0= */"

/***/ }),

/***/ "./src/app/cummulative-summary/cummulative-summary.component.ts":
/*!**********************************************************************!*\
  !*** ./src/app/cummulative-summary/cummulative-summary.component.ts ***!
  \**********************************************************************/
/*! exports provided: CummulativeSummaryComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "CummulativeSummaryComponent", function() { return CummulativeSummaryComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var CummulativeSummaryComponent = /** @class */ (function () {
    function CummulativeSummaryComponent(router, http) {
        var _this = this;
        this.router = router;
        this.http = http;
    ...
    CummulativeSummaryComponent.prototype.ngOnInit = function () {
    };
    CummulativeSummaryComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"] }
    ]; };
    CummulativeSummaryComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-cummulative-summary',
            template: __webpack_require__(/*! raw-loader!./cummulative-summary.component.html */ "./node_modules/raw-loader/index.js!./src/app/cummulative-summary/cummulative-summary.component.html"),
            styles: [__webpack_require__(/*! ./cummulative-summary.component.css */ "./src/app/cummulative-summary/cummulative-summary.component.css")]
        })
    ], CummulativeSummaryComponent);
    return CummulativeSummaryComponent;
}());
...
/* harmony import */ var _quiz_carousel_dialog_quiz_carousel_dialog_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../quiz-carousel-dialog/quiz-carousel-dialog.component */ "./src/app/quiz-carousel-dialog/quiz-carousel-dialog.component.ts");
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(dialog, http, router) {
        this.dialog = dialog;
        this.http = http;
        this.router = router;
    }
    DashboardComponent.prototype.openCarousel = function (data) {
        var _this = this;
        this.http.get('/api/quiz/' + data).subscribe(function (res) {
            if (res) {
                _this.quiz = res;
                ...
                var dialogRef = _this.dialog.open(_quiz_carousel_dialog_quiz_carousel_dialog_component__WEBPACK_IMPORTED_MODULE_3__["QuizCarouselDialogComponent"], {
                    width: '1000px',
                    height: '1000px',
                    data: { sentQuizId: { quizName: _this.quiz.quizName } }
                });
                dialogRef.afterClosed().subscribe(function (result) {
                    console.log('The dialog was closed', result);
                    _this.quizId = result.data;
                });
            }
            else {
...
module.exports = ".loginHeader{\r\n  text-align: center;\r\n  font-size: 5em;\r\n  font-family: 'Oswald', sans-serif;\r\n  color:#106D9D;\r\n}\r\n.mainContent{\r\n  text-align: center;\r\n  margin-top: 20%;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.ngOnInit = function () {
        this.employeeLogin = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            employeeId: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]('')
        });
    };
    //  employee login function, accpet form as parameter
    LoginComponent.prototype.loginEmployee = function (employeeLogin) {
        var _this = this;
        var employeeId = employeeLogin.value.employeeId;
...
/***/ "./src/app/quiz-carousel-dialog/images.service.ts":
/*!********************************************************!*\
  !*** ./src/app/quiz-carousel-dialog/images.service.ts ***!
  \********************************************************/
...
var ImagesService = /** @class */ (function () {
    ...
    ImagesService.prototype.getPresentations = function () {
...
/***/ "./src/app/quiz-carousel-dialog/quiz-carousel-dialog.component.css":
/*!*************************************************************************!*\
  !*** ./src/app/quiz-carousel-dialog/quiz-carousel-dialog.component.css ***!
  \*************************************************************************/
/*! no static exports found */
...
module.exports = "\r\n.ui-carousel{\r\n  height: 800px;\r\n}\r\n\r\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/quiz-carousel-dialog/quiz-carousel-dialog.component.ts":
/*!************************************************************************!*\
  !*** ./src/app/quiz-carousel-dialog/quiz-carousel-dialog.component.ts ***!
  \************************************************************************/
/*! exports provided: QuizCarouselDialogComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "QuizCarouselDialogComponent", function() { return QuizCarouselDialogComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/material/dialog */ "./node_modules/@angular/material/esm5/dialog.es5.js");
...
var QuizCarouselDialogComponent = /** @class */ (function () {
    function QuizCarouselDialogComponent(imagesService, dialogRef, data) {
        var _this = this;
        ...
        this.imagesService.getPresentations()
            ...
            console.log(_this.presentations[0].name);
            console.log(_this.presentations[0].images);
            _this.images = _this.presentations.filter(function (p) { return p.name === _this.quiz.quizName; })[0].images;
            console.log(_this.images);
        });
    }
    QuizCarouselDialogComponent.prototype.ngOnInit = function () {
    };
    QuizCarouselDialogComponent.ctorParameters = function () { return [
        { type: _images_service__WEBPACK_IMPORTED_MODULE_3__["ImagesService"] },
        { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] }
    ]; };
    QuizCarouselDialogComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
    ...
    return QuizCarouselDialogComponent;
}());
...
var QuizComponent = /** @class */ (function () {
    ...
    QuizComponent.prototype.goBackToDash = function () {
